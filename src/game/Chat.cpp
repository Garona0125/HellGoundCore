...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
		...
		{ "gameobject_template",		 PERM_ADM,  PERM_CONSOLE, true,   &ChatHandler::HandleReloadGameobjectTemplateCommand,        "", NULL },
		{ "item_template",				 PERM_ADM,  PERM_CONSOLE, true,   &ChatHandler::HandleReloadItemTemplateCommand,              "", NULL },
		{ "template_creature",			 PERM_ADM,  PERM_CONSOLE, true,   &ChatHandler::HandleReloadCreatureTemplateCommand,          "", NULL },
