		...
		/*if (target->GetTypeId() == TYPEID_PLAYER)
		{
			if (Spell* spell = target->GetCurrentSpell(CURRENT_GENERIC_SPELL))
			{
				if (spell->m_CastItem)
				{
					...
					{
					case 40015:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 19169;
						target->SetDisplayId(19169);
						return;
					case 40016:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 23095;
						target->SetDisplayId(23095);
						return;
					default:
						break;
					}
