...
void World::LoadConfigSettings(bool reload)
{
    ...
    loadConfig(CONFIG_AUTOBROADCAST_INTERVAL, "AutoBroadcast.Timer", MINUTE * IN_MILISECONDS);
	...
	loadConfig(RATE_DROP_QUEST_ITEM, "Rate.Drop.Item.Quest", 1.0f);
    loadConfig(RATE_DROP_MONEY, "Rate.Drop.Money", 1.0f);
    loadConfig(RATE_XP_KILL, "Rate.XP.Kill", 1.0f);
	loadConfig(RATE_XP_PET_KILL, "Rate.XP.PET.Kill", 1.0f);
